                ...
                <div class="col-md-6 minH2 mt-md-0 mt-2 py-3">
                    ...
                    <nav aria-label="breadcrumb ">
                        <ol class="breadcrumb mt-4">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('category.slug',$product->subcategory->slug)}}" class=" text-info text-decoration-none">{{$product->subcategory->name}}</a></li>
                    ...
                    <div class="mt-2 mb-2">
                        <p>يوفر متجر {{get_general_value('website_name')}} {{$product->name}} مع إمكانية تقسيط تابي أو تقسيط تمارا بالإضافة إلى خطط دفع سهلة وميسرة من بنوك أخري
                        </p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <form action="{{route('cart.store')}}" method="POST" style="width: 100%; padding:0 !important">
                            @csrf
                                        ...
                                        <input type="hidden" name="product_id" value=" {{$product->id}}" id="">                                <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <span class="text-danger fw-bold fs-4">{{$product->discount == 0 ? $product->price : $product->price-$product->discount }}  {{get_general_value('currancy')}}
                                    </span>

                                    @if($product->discount != 0) <span class="text-decoration-line-through text-secondary ms-2">{{$product->price}} {{get_general_value('currancy')}}  </span> @endif
